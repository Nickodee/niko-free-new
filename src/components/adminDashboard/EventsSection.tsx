                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center gap-3 text-xs">
                    ...
                    <div className="flex items-center gap-1 text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-medium">{event.fullEvent?.bookings_count || 0}</span>
                    </div>

                    {/* Bucket List (Likes/Hearts) */}
                    <div className="flex items-center gap-1 text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="p-6">
              <div className="space-y-6">
                ...
                {/* Tags/Interests Card */}
                {selectedEvent?.fullEvent?.interests && selectedEvent.fullEvent.interests.length > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
                    <h4 className="font-bold text-lg text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                      <svg className="w-5 h-5 text-[#27aae2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedEvent.fullEvent.interests.map((tag: string, idx: number) => (
                        <span 
                          key={idx} 
                          className="px-3 py-1.5 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 dark:from-blue-900/40 dark:to-indigo-900/40 dark:text-blue-300 rounded-full text-sm font-medium border border-blue-200 dark:border-blue-800"
                        >
                          #{tag}
                        </span>
                      ))}
